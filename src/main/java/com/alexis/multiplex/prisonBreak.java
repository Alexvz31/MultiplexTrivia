 ...
 */
public class prisonBreak extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.alexis.relativlayoutjava/databases/";
    private static final String Database_name = "prisonBreak.db";//NAME of database stored in Assets folder
    ...
    public prisonBreak(Context context) {//constructor
