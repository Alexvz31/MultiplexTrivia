 ...
 */
public class movie3 extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.alexis.relativlayoutjava/databases/";
    private static final String Database_name = "movie3.db";//NAME of database stored in Assets folder
    ...
    public movie3(Context context) {//constructor
