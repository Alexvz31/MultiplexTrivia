 ...
 */
public class gameOfThrones extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.alexis.relativlayoutjava/databases/";
    private static final String Database_name = "gameofThrones.db";//NAME of database stored in Assets folder
    ...
    public gameOfThrones(Context context) {//constructor
