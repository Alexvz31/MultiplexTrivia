...
public class Navigation_Activity extends AppCompatActivity
    ...
    public final static String Message = "com.alexis.relativlayoutjava";
    Button c1, c2, c3, c5;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_scorecard) {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, "Multiplex Trivia");
            ...
            intent.setData(Uri.parse("mailto:"));
            String[] recipents = {"Team6@gmail.com"};
            intent.setType("message/rfc822");
            intent.putExtra(Intent.EXTRA_EMAIL, recipents);
            intent.putExtra(Intent.EXTRA_SUBJECT, "Multiplex Reviews");
